...
export class BreadcrumbComponent implements OnInit {
  ...
  public constructor(private breadcrumbService: BreadcrumbsService, private activatedRoute: ActivatedRoute, private router: Router, protected  _mask: LoadingMaskService) {
    console.log('组件实例化');
  ...
  public getParams() {
    this._mask.change.subscribe(data => {
      console.log(data);
      this.ngOnInit();
