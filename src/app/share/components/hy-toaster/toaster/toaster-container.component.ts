...
@Component({
  ...
  template: `
    <div id="toast-container" [ngClass]="[toasterconfig.positionClass]">
      <app-toaster *ngFor="let toast of toasts" [toast]="toast"
                   [@toastState]="toasterconfig.animation"
                   [iconClass]="toasterconfig.iconClasses[toast.type]"
                   [toastClass]="toasterconfig.typeClasses[toast.type]"
                   (click)="click(toast)" (clickEvent)="childClick($event)"
                   (mouseover)="stopTimer(toast)" (mouseout)="restartTimer(toast)"></app-toaster>
    </div>
  `,
  animations: [
    trigger('toastState', [
